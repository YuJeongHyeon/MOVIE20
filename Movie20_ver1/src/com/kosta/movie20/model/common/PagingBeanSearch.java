...
public class PagingBeanSearch {
	 ...
	 */
	private int postCountPerPage=7;
	/**
	...
	public PagingBeanSearch() {
		
	}
	public PagingBeanSearch(int totalPostCount) {
		this.totalPostCount=totalPostCount;
	}
	public PagingBeanSearch(int totalPostCount, int nowPage) {
		super();
